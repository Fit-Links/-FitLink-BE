...
(
    ...
    status_code         ENUM ('NORMAL', 'REQUIRED_SMS', 'SLEEP', 'SUSPEND', 'DELETE'),
...
(
    ...
    user_id       BIGINT,
    target_type   ENUM ('TRAINER', 'MEMBER'),
...
-- 세션 사용 정보 테이블
CREATE TABLE using_session
(
    using_session_id BIGINT NOT NULL AUTO_INCREMENT,
...
(
    ...
    ref_id     BIGINT,
    type       ENUM ('RESERVATION', 'SESSION', 'CONNECTING'),
    content    VARCHAR(255),
    created_at DATETIME(6),
...
(
    ...
    target_id         BIGINT,
    target_type       ENUM ('MEMBER', 'TRAINER'),
    content           VARCHAR(255),
